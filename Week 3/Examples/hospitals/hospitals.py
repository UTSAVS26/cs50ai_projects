...
class Space():
    ...
    def hill_climb(self, maximum=None, image_prefix=None, log=False):
        ...
        if image_prefix:
            self.output_image(f"hill_climb\{image_prefix}{str(count).zfill(3)}.png")
    ...
    def random_restart(self, maximum, image_prefix=None, log=False):
        ...
        for i in range(maximum):
            ...
            if image_prefix:
                self.output_image(f"random_restart\{image_prefix}{str(i).zfill(3)}.png")
...
print("Using Hill Climb: ")
hospitals = s.hill_climb(image_prefix="hospitals", log=True)
print("\nUsing Random Restart: \n")
